<%@ Page MasterPageFile="~/SzablonStrony.Master" Title="Ankieta" Language="C#" AutoEventWireup="true" CodeFile="Ankieta.aspx.cs" Inherits="Ankieta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <div>
        <asp:MultiView ID="mainMultiView" runat="server" >
            
            <asp:View ID="ankietaOpinieOStronieView" runat="server">
                <asp:Label ID="ankietaOpinieCzestotliwoscOdwiedzaniaLabel" Text="Jak często odwiedza Pan/i stronę internetową / serwis internetowy?" runat="server"/>
                <asp:RadioButtonList ID="ankietaOpinieCzestotliwoscOdwiedzaniaStronyRadioButtonList" runat="server">
                    <asp:ListItem Selected="True" Value="codziennie">Codziennie, lub kilka razy w tygodniu</asp:ListItem>
                    <asp:ListItem Value="raz-w-tygodniu">Raz w tygodniu</asp:ListItem>
                    <asp:ListItem Value="mniej-tydzien">Rzadziej niż raz w tygodniu</asp:ListItem>
                    <asp:ListItem Value="raz-miesiac">Raz w miesiącu</asp:ListItem>
                    <asp:ListItem Value="mniej-miesiac">Rzadziej niż raz w miesiącu</asp:ListItem>
                    <asp:ListItem Value="raz-rok">Raz w roku</asp:ListItem>
                    <asp:ListItem Value="pierwszy-raz">Odwiedziłem/ odwiedziłam ją pierwszy raz</asp:ListItem>
                </asp:RadioButtonList>
                <asp:Label ID="ankietaOpinieZnalezienieInformacjiLabel" Text="Czy znalazł/a Pan/i informacje, których szukał na naszej stronie / serwisie internetowym?" runat="server"/>
                <asp:RadioButtonList ID="ankietaOpinieZnalezienieInformacjiRadioButtonList" runat="server">
                    <asp:ListItem Selected="True" Value="z-tak">Zdecydowanie tak</asp:ListItem>
                    <asp:ListItem Value="r-tak">Raczej tak</asp:ListItem>
                    <asp:ListItem Value="trudno-powiedziec">Trudno powiedziec</asp:ListItem>
                    <asp:ListItem Value="r-nie">Raczej nie</asp:ListItem>
                    <asp:ListItem Value="z-nie">Zdecydowanie nie</asp:ListItem>
                </asp:RadioButtonList>
                <asp:Label ID="ankietaOpinieZadowolenieZeStronyInternetowejLabel" Text="Czy jest Pan/i zadowolony/ zadowolona z używania tej strony internetowej / tego serwisu internetowego?" runat="server"/>
                <asp:RadioButtonList ID="ankietaOpinieZadowolenieZeStronyRadioButtonList" runat="server">
                    <asp:ListItem Selected="True" Value="z-tak">Zdecydowanie tak</asp:ListItem>
                    <asp:ListItem Value="r-tak">Raczej tak</asp:ListItem>
                    <asp:ListItem Value="r-nie">Raczej nie</asp:ListItem>
                    <asp:ListItem Value="z-nie">Zdecydowanie nie</asp:ListItem>
                ...
                <asp:Button ID="ankietaOpinieOStronieWyslijButton" runat="server" Text="Wyślij" OnClick="ankietaOpinieOStronieWyslijButton_Click" />
            </asp:View>
            ...
            <asp:View ID="podsumowanie" runat="server">
                Dziękujemy za wypełnienie ankiety <a href="Default.aspx">Kliknij tutaj, aby przejsć do strony głównej</a><br />
            </asp:View>
        </asp:MultiView></div>
