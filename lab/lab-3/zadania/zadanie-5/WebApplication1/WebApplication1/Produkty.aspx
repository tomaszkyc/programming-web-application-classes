...
SELECT 
  ...
  where ParentProductCategoryID IS NULL" OnSelecting="KategorieSqlDataSource_Selecting"></asp:sqldatasource>
    ...
    <asp:gridview runat="server" AllowPaging="True" DataSourceID="ProduktySqlDataSource" EnableModelValidation="True" PageSize="10" AutoGenerateColumns="False" EnableViewState="False">
        <Columns>
